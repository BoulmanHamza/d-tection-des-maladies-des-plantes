...
$req="select * from user where email_user=?";
            ...
            <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">SMART AGRICULTURE </a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                 <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#biblio">Bibliothèque </a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
				 ...
				 <img class="masthead-avatar mb-5" src="assets/img/logo2.png" style="width:10%; border-radius: 50%;"><h2 class="masthead-heading mb-0">Bienvenue Mr.<?php echo $nom_user.' '.$prenom_user ?></h2>
				 <br>
			<a href="home.php">  <button class="btn btn-success"><i class="far fa-info"></i>	Voir Profile  </button></a>
                <!-- Icon Divider-->
                <div class="divider-custom divider-light">
					...
					<h1 class="masthead-heading mb-0">SMART AGRICULTURE</h1>
                <!-- Masthead Subheading-->
