     ...
     ?>   
        ...
        <section class="page-section portfolio" id="biblio">
            <div class="container">
				...
				<br>
                    <h2 class="page-section-heading text-secondary mb-0 d-inline-block">Plante</h2>
                </div>
                <!-- Icon Divider-->
...
?>
  ...
  <div class="row">
  <select class="form-control col-lg-4 col-sm-4" id="region_plante">
...
var region=document.getElementById("region_plante").value;
